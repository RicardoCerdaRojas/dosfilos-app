...
| 1.6 | Contexto/Género + Principio atemporal + verificación proactiva (8-step spine) | `in-progress` | [phase-1-6-context-genre-principle.md](./phases/phase-1-6-context-genre-principle.md) |
