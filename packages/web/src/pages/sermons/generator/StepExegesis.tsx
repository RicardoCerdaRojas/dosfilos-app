                    ...
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            ...
                            >
                                ...
                                <span className="text-xs font-medium">{t('exegesis.regenerateBtn', 'Regenerar')}</span>
                            </Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>{t('exegesis.regenerateConfirmTitle', '¿Regenerar Estudio Exegético?')}</AlertDialogTitle>
                                <AlertDialogDescription>
                                    {t('exegesis.confirmRegenerate', 'Esta acción volverá a generar todo el análisis exegético y sobrescribirá cualquier cambio manual que hayas realizado. Esta acción no se puede deshacer.')}
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
