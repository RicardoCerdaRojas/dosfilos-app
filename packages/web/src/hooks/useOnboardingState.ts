...
export function useOnboardingState(): OnboardingState {
    ...
    useEffect(() => {
        ...
        // Get sermons count from Firestore user document
        // This will be populated by our analytics system
        const sermonsCreated = (user as any).analytics?.sermonsCreated || 0;
