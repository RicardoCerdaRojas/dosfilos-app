  ...
  return (
    <DialogPortal data-slot='dialog-portal'>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // ⚠ Base uses `sm:max-w-lg` for the mobile→desktop step.
          // Consumers overriding the width MUST pass `sm:max-w-*` (NOT
          // unprefixed `max-w-*`), otherwise tailwind-merge keeps both
          // and the more specific `sm:` here wins on every viewport
          // ≥640px (the override silently has no effect).
